...
import org.junit.runner.RunWith;
    ...
    @CucumberOptions(
            ...
            //"@datatablewithheader"
            tags = "@errorvalidation",  //will execute the tags with @regression in Login.feature class/pg
            ...
            plugin={"pretty","html:target/cucumber.html"}  //("pretty" is just something extra). will provide you all the gherkin steps in your console when you run it below
