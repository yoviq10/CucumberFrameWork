...
public class CommonMethod {
        ...
        public static byte[] takeScreenShot(String fileName){   //was public static void takeScreenShot(String fileName)  before I changed it
            TakesScreenshot ts=(TakesScreenshot)driver;

           byte[] picBytes= ts.getScreenshotAs(OutputType.BYTES); //this byte has to be stored in byte of array
